...
2. After some test against itself, I found that it will always split the stacks and maintaining a tie situation till exceeding the maximum turns(300 turns). I think some encouragement on applying merge can be used.
